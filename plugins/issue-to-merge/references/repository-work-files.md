...
6. On POSIX, set `umask 077` while creating new directories and files; use the platform's user-only
   equivalent elsewhere. Do not relax existing permissions. Never stage or commit `codex-work`
   content.
